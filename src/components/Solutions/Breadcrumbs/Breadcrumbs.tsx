      ...
      <section className="px-rc90 py-rc100 bg-black_111 text-white">
        ...
        <div className={`flex flex-wrap mt-rc74 ${footerClassName}`}>
          {footerHover.map((item, idx) => (
            <div className={`transition-all group ${item} hover:bg-black flex items-center justify-between w-1/2 border border-solid border-gray-e5e6e5 py-rc25 pl-rc15 pr-rc30`}>
