...
const Sections = ({
  ...
  return (
    <div className="Sections">
      <section className={`bg-black text-white section_01 pt-rc40 px-rc90 ${typeof section_02_video === 'string' ? 'pb-rc415' : 'pb-rc90'}`}>
        {section_01_video}
      ...
      <section className="section_02">
        {typeof section_02_video === 'string' ? (
        ...
        <div className="flex pl-rc_8 pr-rc_8 text-rc17 -mt-rc_10">
          <div className="w-full">
            ...
            <div className="font-medium">{section_02_text2}</div>
          </div>
          <div className="border-t border-solid border-gray-999 pt-rc20 ml-rc60 font-medium">{section_02_text3}</div>
        </div>
      </section>
    </div>
  )
