...
const SolutionSEcyion3s = ({
    ...
    return <div className='SolutionSEcyion3s'>
        ...
        <section className="text-black section_03 bg-gray-e5e6e5">
          <div className="px-rc_10 mx-_rc10">
            <div className="text-rc17">
              ...
              <div className="mt-rc40 mb-rc27 text-gray-999 flex justify-between">
                {section_02_spans.map((item, idx) => (
                  <div className="w-rc_23 border-t pt-rc20 border-solid border-black" key={idx}>
                    <strong>
                      {item.start}
                      <br />
                    </strong>
        ...
        <section className="section_02 bg-black text-white">
          ...
          <div className="-mt-rc_10">
            <div className="text-rc45 mb-rc75">
              {section_03_title}
            </div>
